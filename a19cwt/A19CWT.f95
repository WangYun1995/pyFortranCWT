...
Module A19CWT
  ...
  !--------------------------------------------------------------!
  Subroutine rA19CWT_zerobc( signal, Lbox, Nsubs, wavelet_name, Nmesh )
  ...
  !--------------------------------------------------------------!
  Subroutine rA19CWT_periodbc( signal, Lbox, Nsubs, wavelet_name, Nmesh )
  ...
  ! zero boundary condition
  !--------------------------------------------------------------!
  Subroutine cA19CWT_zerobc( signal, Lbox, Nsubs, wavelet_name, Nmesh )
  ...
  ! periodic boundary condition
  !--------------------------------------------------------------!
  Subroutine cA19CWT_periodbc( signal, Lbox, Nsubs, wavelet_name, Nmesh )
